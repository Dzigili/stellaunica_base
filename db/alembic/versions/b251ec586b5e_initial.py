...
Revision ID: b251ec586b5e
Revises: 
Create Date: 2018-09-24 16:10:12.664195
...
def upgrade():
    ...
    op.create_index(op.f('ix_submits_email'), 'submits', ['email'], unique=False)
...
def downgrade():
    ...
    op.drop_index(op.f('ix_submits_email'), table_name='submits')
